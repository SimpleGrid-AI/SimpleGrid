const ROLES = [
  {
    ...
    not: [
      ...
      'A role behind layers. You work directly with the founder and own what you build.',
    ],
    process: [
      'Send your resume and a link to something you have built - a GitHub repo or a deployed app.',
      'Complete the assessment at https://bit.ly/3Ncb7HJ.',
      'Email hello@simplegrid.ai. If your work is interesting, you hear from the founder within 48 hours.',
    ],
  },
  {
    ...
    about: [
      'Most factories run on rigid, decades-old software so slow and confusing that staff abandon it for Excel and WhatsApp. We build the opposite: software that adapts to how a business actually works, goes live in days instead of months, and is simple enough to use by just typing in plain language.',
      'The hard part is not the technology. It is making something powerful feel genuinely simple, and that is where you come in. Your designs ship to real customers, with direct mentorship from the founder and engineering team and no layers in between.',
    ],
    what: [
      ...
      'Collaborate with product managers, developers, and stakeholders to turn requirements into user-centered design.',
      'Support the end-to-end design process, from research and ideation to prototyping, testing, and implementation.',
    ],
    you: [
      'A portfolio (student, personal, or professional) showing clean, usable interface work. How you think matters more than how long your resume is.',
      'Working knowledge of Figma: wireframes, prototypes, and components.',
      'A strong eye for simplicity - you notice clutter and know how to fix it.',
      'Genuine curiosity about how real businesses run, not just making things look good.',
      'A self-starter who can take a rough problem, ask sharp questions, and move without hand-holding.',
      'Bonus: front-end basics (HTML/CSS), or experience designing data-heavy or B2B products.',
    ],
    not: [
      'A pixel-pushing role. You design how the product actually works, not just how it looks.',
      'A remote internship. This is on-site in Bangalore, in the room with the team.',
    ],
    process: [
      'Apply through our form: https://tally.so/r/1ARqeM.',
      'Have your portfolio and a short note on why this interests you ready.',
      'We review applications on a rolling basis and onboard selectively.',
    ],
  },
  {
