function AboutPage() {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("main", {
  ...
  }, "Here's what no software vendor will tell you: most mid-market ERP projects fail or get abandoned. We lived through two of them ourselves - so we built something different.")), /*#__PURE__*/React.createElement("div", {
    className: "why-kpis"
  }, [{
    n: '75%',
    l: 'of mid-market ERP projects fail or get abandoned'
  }, {
    n: '2',
    l: 'ERP failures we lived through ourselves'
  }, {
    n: '30 days',
    l: 'you run it live before you commit'
  }, {
    n: '$0',
    l: 'up front - you pay only when it works'
    ...
    className: "why-kpi-l"
  }, k.l)))), /*#__PURE__*/React.createElement("ol", {
    className: "why-flow"
  }, [{
    h: 'The Factory Ops Cloud',
    p: 'An operations layer that runs your factory floor on top of the QuickBooks or Tally you already use.'
  }, {
    h: 'Everything live, in one place',
    p: 'Jobs, batches, BOMs, QC checkpoints, costing - with no migration and no rip-and-replace.'
  }, {
    h: 'Proven before you commit',
    p: 'We configure it to your floor at our cost, you run it live for 30 days, and you pay only when it works.'
    ...
    className: "why-step-dot",
    "aria-hidden": "true"
  }, "✓"), /*#__PURE__*/React.createElement("div", {
    className: "why-step-body"
  }, /*#__PURE__*/React.createElement("div", {
    className: "why-step-h"
  }, s.h), /*#__PURE__*/React.createElement("p", {
    className: "why-step-p"
  ...
  }, "Banks have run on this idea for centuries - a ledger, never erased. Almost no ERP does. We do - and completed jobs flow from that ledger straight into the QuickBooks or Tally you already run.")))), /*#__PURE__*/React.createElement(Reveal, null, /*#__PURE__*/React.createElement("div", {
    ...
    key: i,
    className: "arch-outcome-cell uth-tile"
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      fontFamily: 'var(--font-heading)',
      fontSize: 16,
    ...
    text: "\"Underneath is an architecture so unusual that even seasoned engineers ask us to draw it twice. Most ERPs are 1990s thinking dressed in 2020s UI. SimpleGrid is what an enterprise system looks like if you started today, with what we now know.\"",
    cite: "- The founding team"
