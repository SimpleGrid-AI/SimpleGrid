          ...
          <div>
            ...
            <Reveal delay={400}>
              <div className="hero-cta">
                ...
                <a href="#how-it-works" className="btn btn-lg btn-outline-white">See how it works</a>
              </div>
            </Reveal>
          </div>
          <Reveal delay={300}>
  ...
  return (
    <section className="section section-blue">
      <div className="container" style={{maxWidth:880,margin:'0 auto',padding:'0 32px'}}>
        <Reveal>
          <div style={{textAlign:'center'}}>
            ...
            <p style={{fontSize:16,color:'var(--fg2)',lineHeight:1.65,maxWidth:600,margin:'0 auto 24px'}}>
              Not a demo. Not a sandbox. A real system built around how your factory actually runs - your orders, your approvals, your production stages, your rules.
            </p>
            <p style={{fontSize:16,color:'var(--fg2)',lineHeight:1.65,maxWidth:600,margin:'0 auto 24px'}}>
        ...
        <Reveal delay={300}>
          <div style={{textAlign:'center'}}>
            <a href="https://calendly.com" target="_blank" rel="noopener" className="btn btn-lg btn-primary">Book a call - zero risk</a>
          </div>
        </Reveal>
      </div>
    </section>
