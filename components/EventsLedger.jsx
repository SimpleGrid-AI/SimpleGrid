...
function ProductHeroNew() {
  ...
  const bgStyle = { paddingTop: 88, paddingBottom: 64, position: 'relative', overflow: 'hidden', background: 'rgba(252,252,253,0.30)', ...heroSize };
  ...
  return (
    <section className="section" style={bgStyle}>
      ...
      <div className="container" style={{ position: 'relative', zIndex: 2 }}>
        <div className="tag" style={{ color: 'var(--fg3)' }}>PLATFORM</div>
        <h1 className="h1" style={{ color: 'var(--fg1)', maxWidth: 980, fontSize: 48, lineHeight: 1.1 }}>
          One system for orders, inventory, production and costing.
        </h1>
        <p className="lead" style={{ color: 'var(--fg2)', maxWidth: 760, marginTop: 18 }}>
          SimpleGrid is the Adaptive ERP for CPG brands, manufacturers and inventory-led businesses. Shaped around your operation, synced to the QuickBooks, Tally or Zoho you already run. Live in 3 weeks or less.
        </p>
        <div style={{ marginTop: 28, display: 'flex', gap: 12, flexWrap: 'wrap' }}>
          <button type="button" onClick={() => setShowInvite(true)} data-cta="product_hero_demo" className="btn btn-lg btn-invite">Book a demo →</button>
        </div>
        <div style={{ marginTop: 36, display: 'flex', gap: 32, flexWrap: 'wrap', fontSize: 'var(--fs-caption)', color: 'var(--fg3)' }}>
...
function MotivationSection() {
  ...
  return (
    <section className="section" id="hank" style={{ background: 'rgba(250,251,252,0.4)', minHeight: 'calc(100vh - 64px)', paddingTop: 48, paddingBottom: 48, display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
      <div className="container">
        <Reveal>
          <div style={{ textAlign: 'center' }}>
            <div className="tag">MEET HANK</div>
            <h2 className="h2 ink" style={{ maxWidth: 760, margin: '0 auto' }}>
              Meet Hank - the AI assistant for your operation.
            </h2>
          </div>
        </Reveal>
        <Reveal delay={150}>
...
function HankChat() {
  const conversation = [
    { role: 'user', day: 'Monday 9:14 AM', text: 'Hank, what goes out today?' },
    { role: 'hank', body: [
      { line: 'Today: ', strong: '5 dispatches · $52k invoiced.' },
      { line: 'Biggest: ', strong: 'Hampton Co', after: ' - 2 trucks, $28k.' },
      { line: 'All 5 packed. QC cleared by Raj, 8:40 AM.' },
    ] },

    { role: 'user', day: 'Tuesday 9:24 AM', text: 'Which orders are running late?' },
    { role: 'hank', body: [
      { line: '3 orders past promise date:' },
      { line: '· ', strong: 'SO-4521 · Hampton Co - 2 days late', after: ' (QC backlog)' },
      { line: '· SO-4533 - 1 day late, packs today' },
      { line: '· SO-4540 - at risk, ships tomorrow' },
    ] },

    { role: 'user', day: 'Tuesday 2:33 PM', text: "What's my margin on the Hampton order?" },
    { role: 'hank', body: [
      { line: 'SO-4521: quoted ', strong: '$16,200', after: ' · landed cost $12,900.' },
      { line: 'Margin: ', strong: '20.4%', after: ' - 1.8 pts below plan.' },
        ...
        <div>
          <div style={{ fontFamily: 'var(--font-heading)', fontWeight: 700, fontSize: 14, color: 'var(--fg1)', display: 'flex', alignItems: 'center', gap: 8 }}>
            ...
            <span style={{
              ...
              color: 'var(--sg-blue)', background: 'rgba(52,97,224,0.12)',
...
function AbilitySection() {
  const html =
    ...
    '</div>';
  return (
    <section className="section" id="ability" style={{ background: 'rgba(255,255,255,0.4)', paddingTop: 110, paddingBottom: 110 }}>
