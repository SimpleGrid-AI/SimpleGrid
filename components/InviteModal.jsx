  ...
  return (
    <div className="modal-overlay" onClick={(e) => { if (e.target === e.currentTarget) onClose(); }}>
      <form className="modal" role="dialog" aria-modal="true" aria-labelledby="invite-h" data-form-name="invite" onSubmit={submit} style={{ position: 'relative' }}>
        ...
        <p className="sub">Tell us about your operation - we set SimpleGrid up around it at our cost, and you run it live for 30 days, free. You pay only when it works.</p>
