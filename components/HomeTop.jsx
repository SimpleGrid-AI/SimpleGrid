      ...
      <div className="container">
        <div className="hero-inner">
          <div>
            ...
            <Reveal delay={200}>
              <p className="hero-sub">SimpleGrid is the operations cloud for CPG brands, manufacturers, and inventory-led businesses. Built around how you already work.</p>
            </Reveal>
            <Reveal delay={400}>
              <div className="hero-cta">
                <button type="button" data-cta="hero" className="btn btn-lg btn-invite" onClick={() => { setShowInvite(true); window.sgTrack && window.sgTrack('cta_clicked', {location:'hero'}); }}>
          ...
          <Reveal delay={300}>
            <div className="hero-stat-box" style={{background:'rgba(255,255,255,0.55)', border:'1px solid var(--border)', borderRadius:20, padding:'36px 40px', textAlign:'center', maxWidth:440, margin:'0 auto', boxShadow:'0 24px 60px rgba(20,28,46,0.10)'}}>
              <div style={{fontSize:11, fontWeight:700, textTransform:'uppercase', letterSpacing:'0.18em', color:'var(--fg3)', marginBottom:10}}>Execution speed</div>
              <div style={{fontFamily:'var(--font-heading)', fontSize:64, fontWeight:700, color:'var(--sg-blue)', lineHeight:1, letterSpacing:'-0.04em'}}>
                {'\u22643'}<span style={{fontSize:26, color:'var(--fg2)', marginLeft:12, fontWeight:500, letterSpacing:'normal'}}>weeks</span>
              </div>
              <div style={{fontSize:14, color:'var(--fg2)', marginTop:10}}>From kickoff to live on your real operation.</div>
              <div style={{height:1, background:'var(--border)', margin:'26px 0'}} aria-hidden="true"></div>
              <div style={{fontSize:11, fontWeight:700, textTransform:'uppercase', letterSpacing:'0.18em', color:'var(--fg3)', marginBottom:10}}>Trial</div>
              <div style={{fontFamily:'var(--font-heading)', fontSize:64, fontWeight:700, color:'var(--fg1)', lineHeight:1, letterSpacing:'-0.04em'}}>
                30<span style={{fontSize:26, color:'var(--fg2)', marginLeft:12, fontWeight:500, letterSpacing:'normal'}}>days</span>
              </div>
              <div style={{fontSize:14, color:'var(--fg2)', marginTop:10}}>Real orders. Real team. $0 up front. Then you decide.</div>
            </div>
          </Reveal>
        </div>
      </div>
...
function IntegrationsBar() {
  ...
  const items = [
    { name: 'WhatsApp',     href: 'integrations/whatsapp.html', color: '#25D366', path: 'M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413' },
    { name: 'Slack',        href: 'integrations/slack.html', color: '#4A154B', path: 'M5.042 15.165a2.528 2.528 0 0 1-2.52 2.523A2.528 2.528 0 0 1 0 15.165a2.527 2.527 0 0 1 2.522-2.52h2.52v2.52zM6.313 15.165a2.527 2.527 0 0 1 2.521-2.52 2.527 2.527 0 0 1 2.521 2.52v6.313A2.528 2.528 0 0 1 8.834 24a2.528 2.528 0 0 1-2.521-2.522v-6.313zM8.834 5.042a2.528 2.528 0 0 1-2.521-2.52A2.528 2.528 0 0 1 8.834 0a2.528 2.528 0 0 1 2.521 2.522v2.52H8.834zM8.834 6.313a2.528 2.528 0 0 1 2.521 2.521 2.528 2.528 0 0 1-2.521 2.521H2.522A2.528 2.528 0 0 1 0 8.834a2.528 2.528 0 0 1 2.522-2.521h6.312zM18.956 8.834a2.528 2.528 0 0 1 2.522-2.521A2.528 2.528 0 0 1 24 8.834a2.528 2.528 0 0 1-2.522 2.521h-2.522V8.834zM17.688 8.834a2.528 2.528 0 0 1-2.523 2.521 2.527 2.527 0 0 1-2.52-2.521V2.522A2.527 2.527 0 0 1 15.165 0a2.528 2.528 0 0 1 2.523 2.522v6.312zM15.165 18.956a2.528 2.528 0 0 1 2.523 2.522A2.528 2.528 0 0 1 15.165 24a2.527 2.527 0 0 1-2.52-2.522v-2.522h2.52zM15.165 17.688a2.527 2.527 0 0 1-2.52-2.523 2.526 2.526 0 0 1 2.52-2.52h6.313A2.527 2.527 0 0 1 24 15.165a2.528 2.528 0 0 1-2.522 2.523h-6.313z' },
    { name: 'Gmail',        href: 'integrations/gmail.html', color: '#EA4335', path: 'M24 5.457v13.909c0 .904-.732 1.636-1.636 1.636h-3.819V11.73L12 16.64l-6.545-4.91v9.273H1.636A1.636 1.636 0 0 1 0 19.366V5.457c0-2.023 2.309-3.178 3.927-1.964L5.455 4.64 12 9.548l6.545-4.91 1.528-1.145C21.69 2.28 24 3.434 24 5.457z' },
    { name: 'Excel',        href: 'integrations/excel.html', color: '#217346', path: 'M23.546 1.785H7.93v3.43H0v13.572h7.93v3.428h15.616A.45.45 0 0 0 24 21.764V2.236a.45.45 0 0 0-.454-.451zm-12.16 14.193l-1.998-3.51-1.7 3.255H4.992l3.103-4.937L5.027 5.85h2.768l1.764 3.337L11.357 5.85h2.696l-2.999 5.06 3.108 4.94zm10.875 1.85h-7.95V13.51h2.997v-1.78h-2.997V9.95h2.997V8.16h-2.997V6.376h7.95z' },
    { name: 'Google Sheets',href: 'integrations/google-sheets.html', color: '#34A853', path: 'M11.318 12.545H7.91v-1.909h3.41v1.91zM14.728 0v6h6zm-3.41 8.727H7.91v1.909h3.41V8.727zm1.227 3.818v-1.909h3.41v1.91zm0-3.818v1.909h3.41V8.727zM19.5 24H4.5C3.12 24 2 22.88 2 21.5v-19C2 1.12 3.12 0 4.5 0H14v6h6v15.5c0 1.38-1.12 2.5-2.5 2.5zM18 7.5H6v9h12z' },
    { name: 'QuickBooks',   href: 'integrations/quickbooks.html', color: '#2CA01C', path: 'M12 0A12 12 0 0 0 0 12a12 12 0 0 0 12 12 12 12 0 0 0 12-12A12 12 0 0 0 12 0zm.642 4.1335c.9554 0 1.7296.776 1.7296 1.7332v9.0667h1.6c1.614 0 2.9275-1.3156 2.9275-2.933 0-1.6173-1.3136-2.9333-2.9276-2.9333h-.6654V7.3334h.6654c2.5722 0 4.6577 2.0897 4.6577 4.667 0 2.5774-2.0855 4.6666-4.6577 4.6666H12.642zM7.9837 7.333h3.3291v12.533c-.9555 0-1.73-.7759-1.73-1.7332V9.0662H7.9837c-1.6146 0-2.9277 1.316-2.9277 2.9334 0 1.6175 1.3131 2.9333 2.9277 2.9333h.6654v1.7332h-.6654c-2.5725 0-4.6577-2.0892-4.6577-4.6665 0-2.5771 2.0852-4.6666 4.6577-4.6666Z' },
    { name: 'Tally',        href: 'integrations/tally.html', color: '#D43A2F', path: 'M3 3h3v18H3zM10 3h3v18h-3zM17 3h4v18h-4z' },
    { name: 'Shopify',      href: 'integrations/shopify.html', color: '#95BF47', path: 'M15.337 23.979l7.216-1.561s-2.604-17.613-2.625-17.73c-.018-.116-.114-.192-.211-.192s-1.929-.136-1.929-.136-1.275-1.274-1.439-1.411c-.045-.037-.075-.057-.121-.074l-.914 21.104h.023zM11.71 11.305s-.81-.424-1.774-.424c-1.447 0-1.504.906-1.504 1.141 0 1.232 3.24 1.715 3.24 4.629 0 2.295-1.44 3.76-3.406 3.76-2.354 0-3.54-1.465-3.54-1.465l.646-2.086s1.245 1.066 2.28 1.066c.675 0 .975-.545.975-.932 0-1.619-2.654-1.694-2.654-4.359-.034-2.237 1.571-4.416 4.827-4.416 1.257 0 1.875.361 1.875.361l-.945 2.715-.02.01zM11.17.83c.136 0 .271.038.405.135-.984.465-2.064 1.639-2.508 3.992-.656.213-1.293.405-1.889.578C7.697 3.75 8.951.84 11.17.84V.83zm1.235 2.949v.135c-.754.232-1.583.484-2.394.736.466-1.777 1.333-2.645 2.085-2.971.193.501.309 1.176.309 2.1zm.539-2.234c.694.074 1.141.867 1.429 1.755-.349.114-.735.231-1.158.366v-.252c0-.752-.096-1.371-.271-1.871v.002zm2.992 1.289c-.02 0-.06.021-.078.021s-.289.075-.714.21c-.423-1.233-1.176-2.37-2.508-2.37h-.115C12.135.209 11.669 0 11.265 0 8.159 0 6.675 3.877 6.21 5.846c-1.194.365-2.063.636-2.16.674-.675.213-.694.232-.772.87-.075.462-1.83 14.063-1.83 14.063L15.009 24l.927-21.166z' },
    { name: 'Amazon',       href: 'integrations/amazon.html', color: '#FF9900', path: 'M.045 18.02c.072-.116.187-.124.348-.022 3.636 2.11 7.594 3.166 11.87 3.166 2.852 0 5.668-.533 8.447-1.595l.315-.14c.138-.06.234-.1.293-.13.226-.088.39-.046.525.13.12.174.09.336-.12.48-.256.19-.6.41-1.006.654-1.244.743-2.64 1.316-4.185 1.726a17.617 17.617 0 01-10.951-.577 17.88 17.88 0 01-5.43-3.35c-.1-.074-.151-.15-.151-.22 0-.047.021-.09.051-.13zm6.565-6.218c0-1.005.247-1.863.743-2.577.495-.71 1.17-1.25 2.04-1.615.796-.335 1.756-.575 2.912-.72.39-.046 1.033-.103 1.92-.174v-.37c0-.93-.105-1.558-.3-1.875-.302-.43-.78-.65-1.44-.65h-.182c-.48.046-.896.196-1.246.46-.35.27-.575.63-.675 1.096-.06.3-.206.465-.435.51l-2.52-.315c-.248-.06-.372-.18-.372-.39 0-.046.007-.09.022-.15.247-1.29.855-2.25 1.82-2.88.976-.616 2.1-.975 3.39-1.05h.54c1.65 0 2.957.434 3.888 1.29.135.15.27.3.405.48.12.165.224.314.283.45.075.134.15.33.195.57.06.254.105.42.135.51.03.104.062.3.076.615.01.313.02.493.02.553v5.28c0 .376.06.72.165 1.036.105.313.21.54.315.674l.51.674c.09.136.136.256.136.36 0 .12-.06.226-.18.314-1.2 1.05-1.86 1.62-1.963 1.71-.165.135-.375.15-.63.045a6.062 6.062 0 01-.526-.496l-.31-.347a9.391 9.391 0 01-.317-.42l-.3-.435c-.81.886-1.603 1.44-2.4 1.665-.494.15-1.093.227-1.83.227-1.11 0-2.04-.343-2.76-1.034-.72-.69-1.08-1.665-1.08-2.94l-.05-.076zm3.753-.438c0 .566.14 1.02.425 1.364.285.34.675.512 1.155.512.045 0 .106-.007.195-.02.09-.016.134-.023.166-.023.614-.16 1.08-.553 1.424-1.178.165-.28.285-.58.36-.91.09-.32.12-.59.135-.8.015-.195.015-.54.015-1.005v-.54c-.84 0-1.484.06-1.92.18-1.275.36-1.92 1.17-1.92 2.43l-.035-.02zm9.162 7.027c.03-.06.075-.11.132-.17.362-.243.714-.41 1.05-.5a8.094 8.094 0 011.612-.24c.14-.012.28 0 .41.03.65.06 1.05.168 1.172.33.063.09.099.228.099.39v.15c0 .51-.149 1.11-.424 1.8-.278.69-.664 1.248-1.156 1.68-.073.06-.14.09-.197.09-.03 0-.06 0-.09-.012-.09-.044-.107-.12-.064-.24.54-1.26.806-2.143.806-2.64 0-.15-.03-.27-.087-.344-.145-.166-.55-.257-1.224-.257-.243 0-.533.016-.87.046-.363.045-.7.09-1 .135-.09 0-.148-.014-.18-.044-.03-.03-.036-.047-.02-.077 0-.017.006-.03.02-.063v-.06z' },
    { name: 'ShipStation',  href: 'integrations/shipstation.html', color: '#0099FF', path: 'M3 16.2c0-.4.3-.7.7-.7H22c.4 0 .7.3.7.7v.5c0 .4-.3.7-.7.7H3.7c-.4 0-.7-.3-.7-.7zM3 19.4h19c.4 0 .7.3.7.7v.5c0 .4-.3.7-.7.7H3.7c-.4 0-.7-.3-.7-.7v-.5c0-.4.3-.7.7-.7zM3 12.3c0-.4.3-.7.7-.7h13.6c.4 0 .7.3.7.7v.5c0 .4-.3.7-.7.7H3.7c-.4 0-.7-.3-.7-.7zM3 8.4c0-.4.3-.7.7-.7h10c.4 0 .7.3.7.7v.5c0 .4-.3.7-.7.7H3.7c-.4 0-.7-.3-.7-.7zM3 4.5c0-.4.3-.7.7-.7H22c.4 0 .7.3.7.7V5c0 .4-.3.7-.7.7H3.7c-.4 0-.7-.3-.7-.7z' },
  ];
...
function TrustStrip() {
  ...
  return (
    <div aria-label="Recognized by" style={{
      ...
      borderTop:'1px solid var(--sg-black)', borderBottom:'1px solid var(--sg-black)', background:'rgba(250,251,252,0.45)'
    }}>
  ...
  const pains = [
    {
      ...
      href: 'solutions.html#built-for-you', cta: 'pain_built_for_you',
    },
    {
      n: '02', t: 'Costing is guesswork',
      ...
      href: 'solutions.html#costing', cta: 'pain_costing',
    },
    {
      n: '03', t: "No one can see what's happening",
      ...
      href: 'solutions.html#visibility', cta: 'pain_visibility',
    },
    {
      n: '04', t: 'Planning lives in spreadsheets',
      ...
      href: 'solutions.html#planning', cta: 'pain_planning',
    },
    {
      n: '05', t: 'Paying before it works',
      ...
      href: 'solutions.html#pay-before', cta: 'pain_pricing',
    },
  ];
  return (
    <section className="section section-screen" id="why-erp">
      <div className="container">
        <Reveal>
          <div className="pj-head">
            <div className="tag">WHY ERPs ARE BROKEN</div>
            <h2 className="h2">Most ERPs were never built to run your floor.</h2>
            <p className="lead">They started as accounting tools - great at booking numbers, not at running operations. The rest were enterprise systems scaled down to fit you. Either way, you hit the same five problems.</p>
          </div>
        </Reveal>
          ...
          {pains.map((p, i) => (
            <Reveal key={i} delay={i * 90}>
              <div className="pj-row">
                <span className="pj-num" aria-hidden="true">{p.n}</span>
                <div className="pj-body">
                  <h3 className="pj-t">{p.t}</h3>
                  <p className="pj-pain">{p.pain}</p>
                  <p className="pj-answer">{p.answer}</p>
                </div>
                <a className="pj-link" href={p.href} data-cta={p.cta}>See how &rarr;</a>
              </div>
            </Reveal>
          ))}
        </div>
...
function WhatIsSimpleGrid() {
  const cards = [
    { t: 'Built for you', d: 'Only the screens you need. Nothing extra.' },
    { t: 'Live in weeks', d: 'Under 3 weeks to go live. A working demo in 72 hours.' },
    { t: 'Books stay put', d: 'Connects to QuickBooks, Tally, Zoho and 20+ tools. No migration.' },
  ];
  return (
    <section className="section section-beige section-roomy" id="what-is">
      <div className="container">
        <Reveal>
          <div className="tag">WHAT IS SIMPLEGRID</div>
          <h2 className="h2">An ERP built around you. Not the other way around.</h2>
          <p className="lead" style={{maxWidth:720}}>SimpleGrid is an operations cloud for CPG brands, manufacturers and inventory-led businesses. It runs your orders, inventory, production, planning and costing in one place - and it is shaped around how you already work.</p>
        </Reveal>
        <div className="wis-grid">
          {cards.map((c, i) => (
            <Reveal key={i} delay={i * 90}>
              <div className="wis-card">
                <h3 className="wis-t">{c.t}</h3>
                <p className="wis-d">{c.d}</p>
              </div>
            </Reveal>
          ))}
        </div>
...
function MeetHankHome() {
  return (
    <section className="section section-roomy" id="hank">
      <div className="container">
        <div className="mh-grid">
          <div>
            <Reveal>
              <div className="tag">MEET HANK</div>
              <h2 className="h2">The AI assistant your team already knows how to use.</h2>
              <p className="lead" style={{maxWidth:520}}>If your team can text, they can use SimpleGrid. Real-time answers from live data, on desktop and the mobile app.</p>
              <a className="mh-link" href="product.html#hank" data-cta="hank_home">See Hank on the platform &rarr;</a>
            </Reveal>
          </div>
          <Reveal delay={120}>
            <div className="mh-chat" aria-label="Example questions for Hank">
              <div className="mh-chat-head"><HankAva /><span>Hank</span></div>
              <div className="mh-chat-body">
                <div className="hank-row user"><div className="hank-bubble user">What did we dispatch today?</div></div>
                <div className="hank-row user"><div className="hank-bubble user">Which orders are running late?</div></div>
                <div className="hank-row user"><div className="hank-bubble user">What is my margin on the Wilson order?</div></div>
                <div className="hank-row bot"><HankAva /><div className="hank-bubble bot">38.2% on the Wilson order. Costed with your formula, updated 2 minutes ago.</div></div>
              </div>
            </div>
          </Reveal>
        </div>
...
function HowItWorks() {
  const [showInvite, setShowInvite] = React.useState(false);
  const steps = [
    { k: 'Day 1',    t: 'One call',            d: 'We learn how your operation runs. No forms, no workshops.' },
    { k: 'Day 1-3',  t: 'Working demo',        d: 'You see your own products and process in SimpleGrid within 72 hours.' },
    { k: 'Week 1-3', t: 'We build around you', d: 'Your data moves in. Your team shapes it with us.' },
    { k: 'Day 21',   t: "You're live",         d: 'Run everything on it for 30 days. Keep it only if it works.' },
  ];
  const stats = [
    { v: '≤3 weeks', l: 'to live' },
    { v: '30-day',   l: 'trial' },
  ...
  return (
    <section className="section section-alt section-roomy" id="how-it-works">
      <div className="container">
        <Reveal>
          <div className="tag">HOW IT GOES LIVE</div>
          <h2 className="h2">Your 3 weeks with us go as follows.</h2>
        </Reveal>
        <Reveal delay={100}>
          <ol className="glj-road">
            {steps.map((s, i) => (
              <li className="glj-step" key={i}>
                <span className="glj-node" aria-hidden="true">{i + 1}</span>
                <div className="glj-k">{s.k}</div>
                <div className="glj-t">{s.t}</div>
                <p className="glj-d">{s.d}</p>
              </li>
            ))}
          </ol>
        </Reveal>
        <Reveal delay={180}>
          <div className="glj-stats">
            {stats.map((s, i) => (
              <div className="glj-stat" key={i}>
                <span className="glj-stat-v">{s.v}</span>
                <span className="glj-stat-l">{s.l}</span>
              </div>
            ))}
          </div>
          <div style={{textAlign:'center',marginTop:26}}>
            <button type="button" data-cta="how_it_works" className="btn btn-lg btn-invite" onClick={() => { setShowInvite(true); window.sgTrack && window.sgTrack('cta_clicked', {location:'how_it_works'}); }}>Book a demo</button>
          </div>
        </Reveal>
      </div>
      <style>{`
...
function SelectiveOnboarding() {
  ...
  const stats = [
    { v: '≤3 weeks', l: 'to live' },
    { v: '30 days',  l: 'trial on your real operations' },
    { v: 'Our cost', l: 'to configure' },
  ];
  return (
    <>
    <section className="section section-roomy" id="onboarding">
      <div className="container" style={{maxWidth:880}}>
        <Reveal>
          <div style={{textAlign:'center'}}>
            <div style={{display:'inline-flex',alignItems:'center',gap:10,marginBottom:12}}>
              <span aria-hidden="true" className="so-kicker-dot" />
              <span style={{fontSize:11,fontWeight:700,letterSpacing:'0.18em',textTransform:'uppercase',color:'var(--fg3)'}}>Selective onboarding</span>
            </div>
            <h2 className="h2" style={{maxWidth:720,margin:'0 auto 12px'}}>
            ...
            <p className="lead" style={{maxWidth:600,margin:'0 auto'}}>
              Our senior engineers and deployment leads are on every deployment. We keep the roster small so every rollout gets them.
            </p>
          </div>
        </Reveal>
        <Reveal delay={140}>
          <div className="so-sonar">
            <span className="so-ring" aria-hidden="true" />
            <span className="so-ring" aria-hidden="true" style={{animationDelay:'1.6s'}} />
            <span className="so-ring" aria-hidden="true" style={{animationDelay:'3.2s'}} />
            <span className="so-ring" aria-hidden="true" style={{animationDelay:'4.8s'}} />
            <span className="so-core" aria-hidden="true" />
            <span className="so-badge"><span className="so-badge-dot" aria-hidden="true" />3 slots open this quarter</span>
          </div>
        </Reveal>
        <Reveal delay={200}>
          <div className="so-promise">
            <p style={{fontSize:15.5,lineHeight:1.6,color:'var(--fg2)',margin:0}}>
              If we take you on, we set SimpleGrid up around <strong style={{color:'var(--fg1)',fontWeight:700}}>how you actually run</strong> - at our cost. Run it live for 30 days: real orders, real team. <strong style={{color:'var(--fg1)',fontWeight:700}}>You pay only when it works.</strong>
            </p>
          </div>
        </Reveal>
        <Reveal delay={260}>
          <div className="so-stats">
            {stats.map((s, i) => (
              <div key={i} className="so-stat">
                <span className="so-stat-v">{s.v}</span>
                <span className="so-stat-l">{s.l}</span>
              </div>
            ))}
          </div>
        </Reveal>
        <Reveal delay={320}>
          <div style={{textAlign:'center'}}>
            <button type="button" data-cta="onboarding" className="btn btn-lg btn-invite" onClick={() => { setShowInvite(true); window.sgTrack && window.sgTrack('cta_clicked', {location:'onboarding'}); }}>
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" style={{marginRight:2}} aria-hidden="true">
                <path d="M12 2l2.39 5.84L20 10l-5.61 2.16L12 18l-2.39-5.84L4 10l5.61-2.16L12 2z" fill="currentColor"/>
              </svg>
              Book a demo
            </button>
            <div style={{fontSize:11,color:'var(--fg3)',marginTop:12,letterSpacing:'0.16em',textTransform:'uppercase',fontWeight:600}}>
              We reply within 24 hours &middot; Select partners only
            </div>
          </div>
        </Reveal>
      </div>
