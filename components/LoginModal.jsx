    ...
    <div className="modal-overlay" onClick={(e) => { if (e.target === e.currentTarget) onClose(); }}>
      <form className="modal" style={{ position: 'relative' }} onSubmit={submit}>
        ...
        <p style={{fontSize:13,color:'var(--fg3)',textAlign:'center',marginTop:14}}>
          Don't have an account? <a href="https://cal.com/simplegrid-ai" target="_blank" rel="noopener" style={{color:'var(--sg-blue)',border:'none'}}>Book a call - it's free</a> to get started.
        </p>
      </form>
    </div>
  );
