function PlatformCapabilities() {
  ...
  return React.createElement(
    "section",
    { className: "section", id: "capabilities", style: { background: "rgba(255,255,255,0.4)", paddingTop: 110, paddingBottom: 110 } },
    React.createElement("div", { className: "container", dangerouslySetInnerHTML: { __html: html } })
  );
}
